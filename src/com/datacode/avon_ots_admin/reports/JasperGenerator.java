...
public class JasperGenerator {
    ...
    public ByteArrayOutputStream generaReporteDejadasCajas(
            List<ModelDetalleCajas> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        for(int i=0;i<valores.size();i++){
            parameters.put("Zona", valores.get(i).getZona());
            parameters.put("Campaña", valores.get(i).getCampana());
            parameters.put("Registro", valores.get(i).getRegistro());
            parameters.put("Orden", valores.get(i).getOrden());
            parameters.put("Item", valores.get(i).getItem());
            parameters.put("Codigo Barra", valores.get(i).getCodigoBarras());
            parameters.put("Dejado en PUP", valores.get(i).getDejadoPup());
        }


        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasCajas.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasCajas.jasper");
        }
    ...
    public ByteArrayOutputStream generaReporteRecolectadasCajas(
            List<ModelDetalleCajas> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        for(int i=0;i<valores.size();i++){
            ...
            parameters.put("Codigo Barra", valores.get(i).getCodigoBarras());
            parameters.put("Dejado en PUP", valores.get(i).getDejadoPup());
            parameters.put("Recoilectado de PUP", valores.get(i).getRecolectadoPup());
        }


        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasCajas.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasCajas.jasper");
        }
    ...
    public ByteArrayOutputStream generaReporteDejadasPremios(
            List<ModelDetallePremios> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        Map<String, Object> parameters = new HashMap<String, Object>();
        for(int i=0;i<valores.size();i++){
            parameters.put("FSC", valores.get(i).getFsc());
            parameters.put("EAN13", valores.get(i).getEan13());
            parameters.put("Cantidad", valores.get(i).getCantidad());
            parameters.put("Dejado en PUP", valores.get(i).getDejadoPup());
        ...
        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasUnitarios.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasUnitarios.jasper");
        }
    ...
    public ByteArrayOutputStream generaReporteRecolectadasPremios(
            List<ModelDetallePremios> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        for(int i=0;i<valores.size();i++){
            ...
            parameters.put("Cantidad", valores.get(i).getCantidad());
            parameters.put("Dejado en PUP", valores.get(i).getDejadoPup());
            parameters.put("Recolestado de PUP", valores.get(i).getRecolectadoPup());
        ...
        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasUnitarios.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasUnitarios.jasper");
        }
    ...
    public ByteArrayOutputStream generaReporteDejadasDocumento(
            List<ModelDetalleDocumento> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        Map<String, Object> parameters = new HashMap<String, Object>();
        for(int i=0;i<valores.size();i++){
            parameters.put("Registro", valores.get(i).getRegitro());
            parameters.put("Enviados CODS", valores.get(i).getEnviadosCods());
            parameters.put("Recibidos CODS", valores.get(i).getRecibidosCods());
            parameters.put("Enviados Remitos", valores.get(i).getEnviadosRemitos());
            parameters.put("Recibidos Remitos", valores.get(i).getRecibidosRemitos());
        ...
        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasDocumentos.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesDejadasDocumentos.jasper");
        }
    ...
    public ByteArrayOutputStream generaReporteRecolectadasDocumento(
            List<ModelDetalleDocumento> valores, String formato,
            String realPath) throws IOException {
        ByteArrayOutputStream archivo = new ByteArrayOutputStream();
        ...
        for(int i=0;i<valores.size();i++){
            ...
            parameters.put("Enviados CODS", valores.get(i).getEnviadosCods());
            parameters.put("Recibidos CODS", valores.get(i).getRecibidosCods());
            parameters.put("Recolectados CODS", valores.get(i).getRecolectadosCods());
            parameters.put("Enviados Remitos", valores.get(i).getEnviadosRemitos());
            parameters.put("Recibidos Remitos", valores.get(i).getRecibidosRemitos());
            parameters.put("Recolectados CODS", valores.get(i).getRecolectadosRemitos());
        ...
        if (formato.equals("XLS")) {
            archivo = generarReporteExcelArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasDocumentos.jasper");
        } else if (formato.equals("PDF")) {
            archivo = generarReportePDFArchivo(archivoSalida, parameters,
                    valores, realPath + "//subReporteOrdenesRecolectadasDocumentos.jasper");
        }
