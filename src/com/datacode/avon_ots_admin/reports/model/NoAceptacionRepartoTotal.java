...
public class NoAceptacionRepartoTotal {
	...
	private String idZona = "", idCampania = "", descZona = "",
			...
			importeTotalZona = "", totalOrdenes = "", cantidadLibresCobro = "",
			porcentaAceptacionLibreCobro = "", sumatoriaTotalOrdenesLibreCobro,
	 ...
	 * @since 20/02/2012
	 */
	public NoAceptacionRepartoTotal(String descZona, String descCampania,
			String porcentaAceptacion, String cantidadOrdenes,
			String importeTotalZona, String totalOrdenes,
			String cantidadLibresCobro, String porcentaAceptacionLibreCobro,
			String sumatoriaTotalOrdenesLibreCobro,
			String ordenesLibresCobroTotales,
			List<NoAceptacionRepartoTotalDetRED> lstDetalle1,
			List<NoAceptacionRepartoTotalDetLibres> lstDetalle2) {
	...
	public void setPorcentaAceptacionLibreCobro(
			String porcentaAceptacionLibreCobro) {
		this.porcentaAceptacionLibreCobro = porcentaAceptacionLibreCobro;
	}
