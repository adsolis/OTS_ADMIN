 ...
 * @since 02/02/2012
 */
public class NoAceptacionRepartoDetalle {
	
	//Atributos de Detalle de Reporte - NAR
	private String no = "",			registro = "",		nombre = "",
				   direccion = "",	entreCalles = "",	poblacion = "",
				   valorCOD = "",	valorPedido = "",	red = "",
				   cajas = "",		unitarios = "",		geoReferencia = "",
				   hrVisita = "",	causaDevolucion = "", atributo1 = "",
				   atributo2 = "";
	
	public NoAceptacionRepartoDetalle(String no, String registro, String nombre, String direccion, String entreCalles,
			String poblacion, String valorCOD, String valorPedido, String red, String cajas, String unitarios, String geoReferencia,
			String hrVisita, String causaDevolucion){
		this.no = no;		this.registro = registro;		this.nombre = nombre;
		this.direccion = direccion;		this.entreCalles = entreCalles;		this.poblacion = poblacion;
		this.valorCOD = valorCOD;		this.valorPedido = valorPedido;		this.red = red;
		this.cajas = cajas;		this.unitarios = unitarios;		this.geoReferencia = geoReferencia;
		this.hrVisita = hrVisita;	this.causaDevolucion = causaDevolucion;	
	}
	 ...
	 * @return the hrVisita
	 */
	public String getHrVisita() {
		return hrVisita;
	}

	/**
	 * @param hrVisita the hrVisita to set
	 */
	public void setHrVisita(String hrVisita) {
		this.hrVisita = hrVisita;
	}

	/**
	 * @return the causaDevolucion
	 */
	...
	/**
	 * @param causaDevolucion the causaDevolucion to set
	 */
