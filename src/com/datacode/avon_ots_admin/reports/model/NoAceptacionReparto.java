...
public class NoAceptacionReparto {
	 ...
	 */
	public NoAceptacionReparto(
			String descZona, String descCampania, String porcentaAceptacion,
			String miVentaNAR, String ordenPendienteEntregar,
			List<NoAceptacionRepartoDetalle> det) {
		...
		this.lstNoAceptacionReparto = det;
	}
