...
public class ModelRepReparto {
	...
	private double acpPremios;
	private double acpPrimeraOrden;
	...
	public double getEnvCajOrd() {
		return envCajOrd;
	}

	public void setEnvCajOrd(double envCajOrd) {
	...
	public double getAcpPremios() {
		return acpPremios;
	}

	public void setAcpPremios(double acpPremios) {
		this.acpPremios = acpPremios;
	}

	public double getAcpPrimeraOrden() {
		return acpPrimeraOrden;
	}

	public void setAcpPrimeraOrden(double acpPrimeraOrden) {
