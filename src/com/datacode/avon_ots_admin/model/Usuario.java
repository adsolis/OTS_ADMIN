...
public class Usuario {
	...
	public Usuario(int idUsuario,
			 String usuario, int idTipoUsuario, String descTipoUsuario, Integer idPerfil, String descPerfil,
			 Integer idPais, String descPais, Integer idLDC, String descLDC, Integer idEmpleado, String descEmpleado,
			 String password, String comentario) {
		this.idUsuario = idUsuario; 			this.usuario = usuario; 
		this.idTipoUsuario = idTipoUsuario; 	this.descTipoUsuario = descTipoUsuario;
		this.idPais = idPais;					this.descPais = descPais;
		this.idLDC = idLDC;						this.descLDC = descLDC;
		this.idPerfil = idPerfil;				this.descPerfil = descPerfil;
		this.idEmpleado = idEmpleado;			this.descEmpleado = descEmpleado;
		this.password = password;				this.comentario = comentario;
	}
