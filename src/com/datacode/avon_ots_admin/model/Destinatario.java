...
public class Destinatario {
	...
	public Destinatario(Integer idDestinatario,
			 ...
			 String apPaterno, String apMaterno, String mail,
			 Integer idPais, String descPais, Integer idLDC, String descLDC,
			 Integer idTipoDestinatario, String descTipoDestinatario) {
		this.idDestinatario = idDestinatario; 	this.clave = clave; 	this.nombre = nombre;
		this.apPaterno = apPaterno;		this.apMaterno = apMaterno;		this.mail = mail;
		this.idPais = idPais;	this.descPais = descPais;
		this.idLDC = idLDC;		this.descLDC = descLDC;
		this.idTipoDestinatario = idTipoDestinatario;		this.descTipoDestinatario = descTipoDestinatario;
	}
