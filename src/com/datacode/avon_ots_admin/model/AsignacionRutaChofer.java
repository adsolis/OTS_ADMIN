...
public class AsignacionRutaChofer {
	 ...
	 * @since 11/01/2012
	 */
	public AsignacionRutaChofer(Integer idAsignacionRutaChofer,
			 String fAsignada, String fDenegada, String tipoAsignacion, Integer idTipoAsignacion,
			 Integer idRuta, String descRuta,
			 Integer idPais, String descPais,
			 Integer idZona, String descZona,
			 Integer idLDC, String descLDC,
			 Integer idEmpleado, String descEmpleado) {
		this.idAsignacionRutaChofer = idAsignacionRutaChofer; this.idTipoAsignacion = idTipoAsignacion;
		this.fAsignada = fAsignada;	this.fDenegada = fDenegada;	this.tipoAsignacion = tipoAsignacion;
		this.idRuta = idRuta;	this.descRuta = descRuta;
		this.idPais = idPais;	this.descPais = descPais;
		this.idZona = idZona; 	this.descZona = descZona;
		this.idLDC = idLDC;		this.descLDC = descLDC;
		this.idEmpleado = idEmpleado;	this.descEmpleado = descEmpleado;
	}
