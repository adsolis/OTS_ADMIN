...
public class Reporte {
	...
	public Reporte(Integer idReporte,
			 String nombre, String descripcion, String comentario, String rutaTemplate, String nombreTemplate,
			 Integer idPais, String descPais, Integer idLDC, String descLDC) {
		this.idReporte = idReporte; 	this.nombre = nombre; 				this.descripcion = descripcion;
		this.comentario = comentario; 	this.rutaTemplate = rutaTemplate;	this.nombreTemplate = nombreTemplate;
