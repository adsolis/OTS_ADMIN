...
public class Empleado {
	 ...
	 * @since 10/01/2012
	 */
	public Empleado(Integer idEmpleado, String nombre, String apPaterno, String apMaterno,
			 String domicilio, String feNacimiento, Integer idSexo, String sexo, Integer idEdoCivil, String edoCivil,
			 String rfc, String feIngreso, String telefono, String mail,
			 Integer idEstatus,String descEstatus,
			 Integer idPuesto, String descPuesto,
			 Integer idLDC, String descLDC) {
		
		this.idEmpleado = idEmpleado;
		this.nombre = nombre;				this.apPaterno = apPaterno;
		this.apMaterno = apMaterno;			this.domicilio = domicilio;
		this.feNacimiento = feNacimiento;	this.idSexo = idSexo;	 		this.sexo = sexo;
		this.idEdoCivil= idEdoCivil;		this.edoCivil = edoCivil;		this.rfc = rfc;
		this.feIngreso = feIngreso;			this.telefono = telefono;		this.mail = mail;
		this.idEstatus = idEstatus; 		this.descEstatus = descEstatus;
		this.idLDC = idLDC;					this.descLDC = descLDC;
		this.idPuesto = idPuesto;			this.descPuesto = descPuesto;
	}
