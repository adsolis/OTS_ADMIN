...
public class LineaTransporte {
	 ...
	 * @since 11/01/2012
	 */
	public LineaTransporte(Integer idLineaTransporte,
			 String clave, String descripcion, String telefono, String domicilio,
			 Integer idPais, String descPais) {
		this.idLineaTransporte = idLineaTransporte; 
		this.clave = clave;	this.descripcion = descripcion;
		this.telefono = telefono;	this.domicilio = domicilio;
