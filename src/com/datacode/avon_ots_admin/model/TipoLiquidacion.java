...
public class TipoLiquidacion {
	 ...
	 * @author brenda.estrada
	 * @since 18/01/2012
	 * @param idTipoLiquidacion
	 * @param descripcion
	 * @param clave
	 * @param lastupd_ts
	 */
	public TipoLiquidacion(Integer idTipoLiquidacion, String descripcion, String clave, String lastupd_ts,
			String fechaActualizado, String usuarioActualiza) {
		this.idTipoLiquidacion = idTipoLiquidacion;		this.descripcion = descripcion;
		this.clave = clave;								this.lastupd_ts = lastupd_ts;
