...
public class AsignacionUnidadReparto {
	 ...
	 * @since 10/01/2012
	 */
	public AsignacionUnidadReparto(Integer idAsignacionUnidadReparto, 
			 String noSerie,
			 String fAsignada, String fDenegada,
			 Integer idEmpleado, String descEmpleado,
			 Integer idUnidadReparto, String descUnidadReparto,
		...
		this.idPais = idPais;
		this.descPais = descPais; this.idEstatus = idEstatus; this.descEstatus = descEstatus;
	}
