...
public class RepresentantesPorRuta {
	 ...
	 * @since 11/01/2012
	 */
	public RepresentantesPorRuta(Integer idRepresentanteRuta,
			 String fAlta, String fBaja, String seqEntregaAnterior, String seqEntregaReciente,
			 Integer idRepresentante, String descRepresentante,
			 Integer idRuta, String descRuta, String idZona, String descZona) {
		this.idRepresentanteRuta = idRepresentanteRuta; 	this.fAlta = fAlta;			this.fBaja = fBaja;
		this.seqEntregaAnterior = seqEntregaAnterior;		this.seqEntregaReciente = seqEntregaReciente;
