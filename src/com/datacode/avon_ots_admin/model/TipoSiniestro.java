...
public class TipoSiniestro {
	 ...
	 * @author brenda.estrada
	 * @since 18/01/2012
	 * @param idTipoSiniestro
	 * @param clave
	 * @param descripcion
	 * @param lastupd_ts
	 */
	public TipoSiniestro(Integer idTipoSiniestro, String clave, String descripcion, String lastupd_ts,
			String fechaActualizado, String usuarioActualiza) {
		this.idTipoSiniestro = idTipoSiniestro;		this.clave = clave;
		this.descripcion = descripcion;		this.lastupd_ts = lastupd_ts;
