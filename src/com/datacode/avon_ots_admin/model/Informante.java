...
public class Informante {
	 ...
	 * @since 10/01/2012
	 * */
	public Informante(Integer idInformante,
			 String descripcion,
			 Integer idTipoInformante, String descTipoInformante,
			 Integer idLDC, String descLDC,
			 Integer idPais, String descPais) {
		this.idInformante = idInformante; 	this.descripcion = descripcion;
		this.idTipoInformante = idTipoInformante;	this.descTipoInformante = descTipoInformante;
