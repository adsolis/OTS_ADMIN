...
public class Division {
	 ...
	 * @param admor			- Administrador
	 * @param asistente
	 * @param lastupd_ts
	 */
	public Division(Integer idDivision, String  nombre, String areaGeografica, 
			String admor, String asistente, String lastupd_ts, String fechaActualizado, String usuarioActualiza){
		this.idDivision = idDivision;			this.nombre = nombre;
		this.areaGeografica = areaGeografica;	this.admor = admor;
		this.asistente = asistente;				this.lastupd_ts = lastupd_ts;
