/**
 * Mapeo de las propiedades del Objeto de la BD - PW_ZONA
 */
 ...
 * @since 27/12/2011
 * @category Map
 * @version  Se agrego descLDC, descDivision y nombreGerenteZonal en GET y SET 	 - 18-01-2012
 */
public class Zona {
	...
	public Zona(){
		...
		idLDC = null; descLDC = null;
		idDivision = null; descDivision = null;
		tipoZona = null;
	 ...
	 * @param descDivision
	 * @param tipoZona
	 * @param nombreGerenteZonal
	 */
	public Zona(String idZona, String zona, String anioCampaniaActual, String campania,
			String lastUpdTs, String fechaActualizado, String usuarioActualiza, String idLDC,
			String descLDC, String idDivision, String descDivision, String tipoZona, String nombreGerenteZonal){
		this.idZona = idZona;							this.zona = zona;
		this.anioCampaniaActual = anioCampaniaActual;	this.campania = campania;
		this.lastUpdTs = lastUpdTs;						this.fechaActualizado = fechaActualizado;
		this.usuarioActualiza = usuarioActualiza;
		this.idLDC = idLDC; 							this.descLDC = descLDC;
		this.idDivision = idDivision; 					this.descDivision = descDivision;
		this.tipoZona = tipoZona;						this.nombreGerenteZonal = nombreGerenteZonal;	
	}
