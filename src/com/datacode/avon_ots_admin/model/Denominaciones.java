...
public class Denominaciones {
	...
	public Denominaciones(Integer idDenominacion, String denominacion, String tipo, Integer idTipo){
		this.idDenominacion = idDenominacion;
		this.denominacion = denominacion;	this.tipo = tipo; this.idTipo = idTipo;
	}
