...
public class DispositivoMovil {
	 ...
	 * @since 12/01/2012
	 */
	public DispositivoMovil(Integer idDispositivoMovil,  String noSerie, String marca,
			 String modelo, String macAdress, String direccionIP,
			 Integer idLDC, String descLDC,
			 Integer idPais, String descPais, Integer idEstatus, String descEstatus) {
		this.idDispositivoMovil = idDispositivoMovil;
		this.noSerie = noSerie;		this.marca = marca;	this.modelo = modelo;
		this.macAdress = macAdress;	this.direccionIP = direccionIP;
