...
public class Orden {
	 ...
	 * @param noCajas
	 * @param lastupd_ts
	 * @param fecha_actualizado
	 * @param usuario_actualiza
	 * @param anio
	 * @param cveRuta
	 * @param idRepresentante
	 * @param descRepresentante
	 * @param idLDC
	 * @param descLDC
	 * @param idPrimeraOrden
	 * @param descPrimeraOrden
	 * @param idCampania
	 * @param descCampania
	 * @param idEstatus
	 * @param descEstatus
	 */
	public Orden(Integer idOrden,  Integer idRepresentante,  Integer idLDC, String noCajas,
			 String lastupd_ts, Integer idPrimeraOrden, String cveOrden,  String fecha_actualizado,
			 String usuario_actualiza, Integer idCampania, Integer idEstatus, String descRepresentante,
			 String descLDC, String anio, String descCampania, String cveRuta,  String descPrimeraOrden){
		this.idOrden = idOrden;					this.cveOrden = cveOrden;					this.noCajas = noCajas;
		this.lastupd_ts = lastupd_ts;			this.fecha_actualizado = fecha_actualizado;	this.usuario_actualiza = usuario_actualiza;
		this.idRepresentante = idRepresentante;	this.descRepresentante = descRepresentante;	
		this.idLDC = idLDC;						this.descLDC = descLDC;						this.anio = anio;
		this.idPrimeraOrden = idPrimeraOrden;	this.descPrimeraOrden = descPrimeraOrden;	this.cveRuta = cveRuta;
		this.idCampania = idCampania;			this.descCampania = descCampania; 			this.idEstatus = idEstatus;	
	}
