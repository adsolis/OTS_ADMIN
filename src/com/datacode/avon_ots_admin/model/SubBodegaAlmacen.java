...
public class SubBodegaAlmacen {
	 ...
	 * @since 10/01/2012
	 */
	public SubBodegaAlmacen(Integer idSubbodegaAlmacen,
			 String clave, String descripcion,
			 String telefono, String domicilio,
			 Integer idPais, String descPais, Integer idLDC, String descLDC,
			 Integer idZona, String descZona, Integer idUserResponsableSubbodega, String descUserResponsableSubbodega) {
		this.idSubbodegaAlmacen = idSubbodegaAlmacen; 	this.clave = clave; 	this.descripcion = descripcion;
		this.telefono = telefono;		this.telefono = telefono;	this.domicilio = domicilio;
		this.idPais = idPais;	this.descPais = descPais;
		this.idLDC = idLDC;		this.descLDC = descLDC;
		this.idZona = idZona;		this.descZona = descZona;
		this.idUserResponsableSubbodega = idUserResponsableSubbodega;	this.descUserResponsableSubbodega = descUserResponsableSubbodega;
	}
