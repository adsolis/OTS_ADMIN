...
public class AccesoBD {
	...
	static public Connection abrirConexionOTS() {
		...
		//Cargamos el archivo de propiedades para obtener datos de conexión y formar cadena
...
//				            }
				...
				ex.printStackTrace();
				InteractuarArchivos.guardaArchivoLog("Error al establecer conexión a la base de datos: " + ex.toString());
...
//				            }
	...
	/**
	 * Método para obtener el primer resultset de un Stored Procedure ignorando los Update, Insert o Delete que haya antes de la consulta final del SP.
	 * Se debe tomar en cuenta que el SP devuelva sólo una consulta y sea la que se quiere obtener en código, pues de haber más, se obtendría la primera que genera el SP en vez de la última.
	 * Éste método sólo se debe usar con un SP que devuelva una consulta. Para los que no devuelven consultas se debe usar execute o executeUpdate del mismo objeto CallableStatement.
	 * @author jorge.torner
	 * @since 21-12-2011
	 * @param cs -Callable statement que invoca al SP con sus parámetros
