...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  ObtieneRemitos bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtieneRemitos
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtieneRemitos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtieneRemitos",
    ...
    public static class Factory{
        ...
        */
        public static ObtieneRemitos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtieneRemitos object =
                new ObtieneRemitos();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtieneRemitos".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtieneRemitos)com.datacode.avon_ots_ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://avon_ots_ws.datacode.com","registro").equals(reader.getName()) || new javax.xml.namespace.QName("","registro").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://avon_ots_ws.datacode.com","orden").equals(reader.getName()) || new javax.xml.namespace.QName("","orden").equals(reader.getName()) ){
