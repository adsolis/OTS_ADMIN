...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  ActualizarRamitos bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ActualizarRamitos
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":actualizarRamitos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "actualizarRamitos",
    ...
    public static class Factory{
        ...
        */
        public static ActualizarRamitos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActualizarRamitos object =
                new ActualizarRamitos();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"actualizarRamitos".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActualizarRamitos)com.datacode.avon_ots_ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://avon_ots_ws.datacode.com","tipo").equals(reader.getName()) || new javax.xml.namespace.QName("","tipo").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://avon_ots_ws.datacode.com","codigo").equals(reader.getName()) || new javax.xml.namespace.QName("","codigo").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://avon_ots_ws.datacode.com","idRemito").equals(reader.getName()) || new javax.xml.namespace.QName("","idRemito").equals(reader.getName()) ){
