...
/**
 * ObtenerCajasOrdenDejadaRecolectada.java
 *
...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  ObtenerCajasOrdenDejadaRecolectada bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerCajasOrdenDejadaRecolectada
        implements org.apache.axis2.databinding.ADBBean{
        
                /**
				 * 
				 */
				private static final long serialVersionUID = -6251866923019228320L;



				public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://avon_ots_ws.datacode.com",
                "obtenerCajasOrdenDejadaRecolectada",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerCajasOrdenDejadaRecolectada",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerCajasOrdenDejadaRecolectada",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerCajasOrdenDejadaRecolectada parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerCajasOrdenDejadaRecolectada object =
                new ObtenerCajasOrdenDejadaRecolectada();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerCajasOrdenDejadaRecolectada".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerCajasOrdenDejadaRecolectada)com.datacode.avon_ots_ws.model.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
