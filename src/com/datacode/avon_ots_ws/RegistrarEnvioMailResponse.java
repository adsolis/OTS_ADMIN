...
/**
 * RegistrarEnvioMailResponse.java
 *
...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  RegistrarEnvioMailResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RegistrarEnvioMailResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                /**
				 * 
				 */
				private static final long serialVersionUID = -5554214925079020784L;
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"registrarEnvioMailResponse".equals(type)){
                                ...
                                return (RegistrarEnvioMailResponse)com.datacode.avon_ots_ws.model.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
