...
public class LiquidacionRepartoWeb implements Serializable {
	...
	private String cantidadItemsString = "";

	private Integer cantidadCajas = null;

	private String cantidadCajasString = "";

	private Integer cantidadPremiosUnitarios = null;

	private String cantidadPremiosUnitariosString = "";
	...
	private String idRutaEnrutado = "";

	private String secuenciaEnrutado = "";

	private String idRepresentanteEnrutado = "";

	private String enrutadoRutaSecuenciaOriginal = "";

	private String rutaSecuenciaEnrutado = "";

	private Integer huboCambiosPagos = null;

	private Integer huboCambiosRazonDevolucion = null;
	...
	public String getCantidadItemsString() {
		if (getCantidadItems() == null || getCantidadItems() < 1) {
			this.cantidadItemsString = "0";
		} else {
			this.cantidadItemsString = getCantidadItems().toString();
		}
		return this.cantidadItemsString;
	}

	public void setCantidadItemsString(String cantidadItemsString) {
		this.cantidadItemsString = cantidadItemsString;
	}

	public String getCantidadCajasString() {
		if (getCantidadCajas() == null || getCantidadCajas() < 1) {
			this.cantidadCajasString = "0";
		} else {
			this.cantidadCajasString = getCantidadCajas().toString();
		}
		return this.cantidadCajasString;
	}

	public void setCantidadCajasString(String cantidadCajasString) {
		this.cantidadCajasString = cantidadCajasString;
	}

	public String getCantidadPremiosUnitariosString() {
		if (getCantidadPremiosUnitarios() == null || getCantidadPremiosUnitarios() < 1) {
			this.cantidadPremiosUnitariosString = "0";
		} else {
			this.cantidadPremiosUnitariosString = getCantidadPremiosUnitarios().toString();
		}
		return this.cantidadPremiosUnitariosString;
	}

	public void setCantidadPremiosUnitariosString(
			String cantidadPremiosUnitariosString) {
		this.cantidadPremiosUnitariosString = cantidadPremiosUnitariosString;
	}

	public String getIdRutaEnrutado() {
		return idRutaEnrutado;
	}

	public void setIdRutaEnrutado(String idRutaEnrutado) {
		this.idRutaEnrutado = idRutaEnrutado;
	}

	public String getSecuenciaEnrutado() {
		return secuenciaEnrutado;
	}

	public void setSecuenciaEnrutado(String secuenciaEnrutado) {
		this.secuenciaEnrutado = secuenciaEnrutado;
	}

	public String getIdRepresentanteEnrutado() {
		return idRepresentanteEnrutado;
	}

	public void setIdRepresentanteEnrutado(String idRepresentanteEnrutado) {
		this.idRepresentanteEnrutado = idRepresentanteEnrutado;
	}
	...
	public String getRutaSecuenciaEnrutado() {
		return rutaSecuenciaEnrutado;
	}

	public void setRutaSecuenciaEnrutado(String rutaSecuenciaEnrutado) {
		this.rutaSecuenciaEnrutado = rutaSecuenciaEnrutado;
	}

	public Integer getHuboCambiosPagos() {
		return huboCambiosPagos;
	}

	public void setHuboCambiosPagos(Integer huboCambiosPagos) {
		this.huboCambiosPagos = huboCambiosPagos;
	}

	public Integer getHuboCambiosRazonDevolucion() {
		return huboCambiosRazonDevolucion;
	}

	public void setHuboCambiosRazonDevolucion(Integer huboCambiosRazonDevolucion) {
		this.huboCambiosRazonDevolucion = huboCambiosRazonDevolucion;
	}
