...
/**
 * ObtenerDocumentosOrdenDejadaRecolectada.java
 *
...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  ObtenerDocumentosOrdenDejadaRecolectada bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerDocumentosOrdenDejadaRecolectada
        implements org.apache.axis2.databinding.ADBBean{
        
                /**
				 * 
				 */
				private static final long serialVersionUID = 9149288766113868895L;



				public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://avon_ots_ws.datacode.com",
                "obtenerDocumentosOrdenDejadaRecolectada",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerDocumentosOrdenDejadaRecolectada",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerDocumentosOrdenDejadaRecolectada",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerDocumentosOrdenDejadaRecolectada parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerDocumentosOrdenDejadaRecolectada object =
                new ObtenerDocumentosOrdenDejadaRecolectada();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerDocumentosOrdenDejadaRecolectada".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerDocumentosOrdenDejadaRecolectada)com.datacode.avon_ots_ws.model.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
